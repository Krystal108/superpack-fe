            ...
            <ul class="big-nav_list">
                ...
                <li>
                    ...
                    <ul class="dropdown-container">
                        <li><a href="/?page=attendance-check">Checking Attendance</a></li>
                        <li><a href="/?page=worker-eval">Evaluation</a></li>
                    </ul>
                </li>
                <li>
                    <a href="/?page=payroll">
                ...
                <li>
                    <a href="/?page=task-management">
                        <span class="icon"><i class="fas fa-chart-bar"></i></span>
                        <span class="title">Task Management</span>
                    </a>
                </li>
                <li>
                    <a href="/?page=employee-list">
